        ...
        */
		...
		Scanner sc = new Scanner(System.in);
                ...
                while(!arreter) {
                        ...
                        String pionX = sc.nextLine();
                        System.out.println("y = ");
                        String pionY = sc.nextLine();
                        ...
                        while(!valide) {
                                if(controleur.getJoueurActuel() == controleur.getJ1()) {
                                        ...
                                        while(i < controleur.getListeJ1().size() && !valide) {
                                                ...
                                                if( Integer.valueOf(pionX) == controleur.getListeJ1().get(i).getPosX() && Integer.valueOf(pionY) == controleur.getListeJ1().get(i).getPosY() ) {
                                        ...
                                        while(j < controleur.getListeJ2().size() && !valide) {
                                                ...
                                                if( Integer.valueOf(pionX) == controleur.getListeJ2().get(j).getPosX() && Integer.valueOf(pionY) == controleur.getListeJ2().get(j).getPosY() ) {
                                                        //vérifie si le pion est disponible
                        ...
                        while(!saisieValide){
                                // Scanner sc = new Scanner(System.in);
                                saisie = sc.nextLine();
                                if((0 < Integer.valueOf(saisie)) && (Integer.valueOf(saisie)< 5)){
                                        saisieValide = true;
                                }
                                else{ System.out.println("!!! Saisie invalide !!!"); }
                        }

                        if(Integer.valueOf(saisie) == 1) {
                                valide = false;
                        ...
                        else if (Integer.valueOf(saisie) == 2) {
                                valide = false;

                                System.out.println("Ou voulez-vous deplacer votre pion ? Saisissez les nouvelles coordonnees : ");
                                System.out.println("x = ");
                                String nouvX = sc.nextLine();
                                System.out.println("y = ");
                                String nouvY = sc.nextLine();
                                valide = controleur.libererPion(Integer.valueOf(nouvX), Integer.valueOf(nouvY), pion);
                                arreter = true;
                        ...
                        else if (Integer.valueOf(saisie) == 3) {
                                valide = false;
                                valide = controleur.voirPion(this, pion);
                                arreter = true;
                        }
                        else if (Integer.valueOf(saisie) == 4) {
